...
バイブコーディングやプログラミング系のネタでも、ターゲットはエンジニアではなく「AIを活用したい一般の人・非エンジニア」。
...
{
  "coverTitle": "表紙タイトル（改行は\\nで表現。2〜3行。以下のいずれかの型を使って、思わず読みたくなるタイトルにする: ①常識破壊型「○○はもう古い」「○○は間違い」 ②煽り型「まだ○○してるの？」「知らないとヤバい」 ③数字＋ギャップ型「○○するだけで△△になる方法」 ④問いかけ型「○○って知ってた？」。普通のまとめタイトルは絶対NG。読者がドキッとする・気になって仕方ない言葉を選ぶ）",
  ...
  "mainSlides": [
    {
      ...
      "text": "説明テキスト（50〜60文字程度。「コイツ面白いな」と思わせるエンタメ感のある話し言葉で書く。ただの解説は禁止。自分のリアクション・ツッコミ・驚きを混ぜる。例: 「いやコレ、ガチでヤバい…」「え、待って。マジで？」「知らなかった自分を殴りたい」「これ使わん人おる？？」。語尾例: ～ヤバくない？、～なんよマジで、～すぎて震える、～してみ？世界変わるから、～だったわ…。一文ごとに必ず\\nで改行する）"
    }
  ],
...
- coverTitleは日本語で、常識破壊・煽り・ギャップ・問いかけを使い「スクロールを止める」パワーのあるタイトルにする。当たり障りのないまとめタイトルは絶対禁止
...
【ターゲット（厳守）】
AI初心者〜中級者。コーディングは初心者レベル。発信者はエンジニアではなく「AI発信者」。
バイブコーディングやプログラミング系のネタでも、読者はエンジニアではなく「AIを活用したい一般の人・非エンジニア」。
